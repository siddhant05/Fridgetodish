...
<div class="container">
	...
	<div class="three columns">
		<div id="logo">
			 <h1><a href="RecipeHomeServlet"><img src="resource/images/cartoon.png"/></a></h1>
		</div>
	</div>
...
<div class="thirteen columns navigation">
	...
	<nav id="navigation" class="menu nav-collapse">
		<ul>
			...
			<li><a href="#">Recipes</a>
				<ul>
					<li><a href="BrowseRecipeServlet">Browse Recipes</a></li>
					<li><a href="RecipePage1Servlet">Recipe Page #1</a></li>
			...
			<ul>
					<li><a href="UserProfileServlet">Update profile</a></li>
					<li><a href="LoadDataForHome">Logout</a></li>
				</ul>
			</li>
		</ul>
	</nav>
...
<div id="homeSlider" class="royalSlider rsDefaultInv">
	...
	<!-- Slide #1 -->
	<div class="rsContent">
		<a class="rsImg" href="resource/images/sliderA_01.jpg"></a>
	...
	<!-- Slide #2 -->
	<div class="rsContent">
		<a class="rsImg" href="resource/images/sliderA_02.jpg"></a>
	...
	<!-- Slide #3 -->
	<div class="rsContent">
		<a class="rsImg" href="resource/images/sliderA_03.jpg"></a>
	...
	<!-- Slide #4 -->   
	<div class="rsContent">
		<a class="rsImg" href="resource/images/sliderA_04.jpg"></a>
	...
	<!-- Slide #5 -->
	<div class="rsContent">
		<a class="rsImg" href="resource/images/sliderA_05.jpg"></a>
	...
	<div class="twelve columns">
		...
		<div class="isotope">
			...
			<div class="four recipe-box columns">
				...
				<div class="thumbnail-holder">
					<a href="recipe-page-2.html">
						<img src="resource/images/recipeThumb-02.jpg" alt=""/>
						<div class="hover-cover"></div>
						<div class="hover-icon">View Recipe</div>
					</a>
				</div>
			...
			<div class="four recipe-box columns">
				...
				<div class="thumbnail-holder">
					<a href="recipe-page-1.html">
						<img src="resource/images/recipeThumb-03.jpg" alt=""/>
						<div class="hover-cover"></div>
						<div class="hover-icon">View Recipe</div>
					</a>
				</div>
			...
			<div class="four recipe-box columns">
				...
				<div class="thumbnail-holder">
					<a href="recipe-page-2.html">
						<img src="resource/images/recipeThumb-04.jpg" alt=""/>
						<div class="hover-cover"></div>
						<div class="hover-icon">View Recipe</div>
					</a>
				</div>
			...
			<div class="four recipe-box columns">
				...
				<div class="thumbnail-holder">
					<a href="recipe-page-1.html">
						<img src="resource/images/recipeThumb-05.jpg" alt=""/>
						<div class="hover-cover"></div>
						<div class="hover-icon">View Recipe</div>
					</a>
				</div>
			...
			<div class="four recipe-box columns">
				...
				<div class="thumbnail-holder">
					<a href="recipe-page-2.html">
						<img src="resource/images/recipeThumb-07.jpg" alt=""/>
						<div class="hover-cover"></div>
						<div class="hover-icon">View Recipe</div>
					</a>
				</div>
...
<div class="four columns">
	...
	<div class="widget">
		<div class="author-box">
			...
			<img src="resource/images/author-photo.png" alt="">
	...
	<div class="widget">
		...
		<a href="recipe-page-1.html" class="featured-recipe">
			<img src="resource/images/featuredRecipe-01.jpg" alt="">
		...
		<!-- Recipe #2 -->
		<a href="recipe-page-1.html" class="featured-recipe">
			<img src="resource/images/featuredRecipe-02.jpg" alt="">
		...
		<!-- Recipe #3 -->
		<a href="recipe-page-1.html" class="featured-recipe">
			<img src="resource/images/featuredRecipe-03.jpg" alt="">
...
<!-- Style Switcher
================================================== -->
<script src="resource/scripts/switcher.js"></script>
