...
@WebServlet(value="/RecipePage3Servlet")
public class RecipePage3Servlet extends HttpServlet {  
	/**
	 * 
	 */
	...
	//private static final long serialVersionUID = 1L;
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response)  
					...
					try{
						...
						RequestDispatcher rd = getServletContext().getRequestDispatcher("/WEB-INF/recipe-page-3.jsp");
