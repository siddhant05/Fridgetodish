...
@WebServlet(value="/RecipePage10Servlet")
public class RecipePage10Servlet extends HttpServlet {  
	/**
	 * 
	 */
	...
	//private static final long serialVersionUID = 1L;
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response)  
					...
					try{
						...
						RequestDispatcher rd = getServletContext().getRequestDispatcher("/WEB-INF/recipe-page-10.jsp");
