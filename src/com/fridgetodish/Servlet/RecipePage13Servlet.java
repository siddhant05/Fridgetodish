...
@WebServlet(value="/RecipePage13Servlet")
public class RecipePage13Servlet extends HttpServlet {  
	/**
	 * 
	 */
	...
	//private static final long serialVersionUID = 1L;
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response)  
					...
					try{
						...
						RequestDispatcher rd = getServletContext().getRequestDispatcher("/WEB-INF/recipe-page-13.jsp");
