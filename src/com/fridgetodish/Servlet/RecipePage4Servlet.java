...
@WebServlet(value="/RecipePage4Servlet")
public class RecipePage4Servlet extends HttpServlet {  
	/**
	 * 
	 */
	...
	//private static final long serialVersionUID = 1L;
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response)  
					...
					try{
						...
						RequestDispatcher rd = getServletContext().getRequestDispatcher("/WEB-INF/recipe-page-4.jsp");
